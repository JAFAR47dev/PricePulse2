...
class MarketDataService:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        # IMPORTANT: Demo keys use regular URL, not pro-api URL
    ...
    def get_coin_data(self, symbol: str) -> Optional[Dict]:
        ...
        try:
            ...
            # Fetch historical data for technical indicators (90 days of 4H data)
    ...
    def _fetch_ohlc_data(self, coin_id: str, days: int = 90) -> Optional[List]:
        ...
        Note: CoinGecko free tier returns daily candles for >1 day requests
        For 4H candles, we'd need the Pro API or use daily data
        """
        try:
            ...
            # We need to add volume (fetch separately)
