...
from notifications.handler import catch_group_forward
from handlers.risk import risk_message_handler  # ✅ ADD THIS
...
async def global_text_router(update, context):
    ...
    # Priority 4: /risk flow ✅ ADD THIS
    if ud.get("risk_flow", {}).get("active"):
        return await risk_message_handler(update, context)
    
    # Priority 5: Group delivery setup
