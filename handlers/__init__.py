...
def register_all_handlers(app):
       ...
       app.add_handler(CallbackQueryHandler(handle_popular_commands, pattern="^popular_commands$"))
       ...
       app.add_handler(CallbackQueryHandler(handle_pro_features, pattern="^pro_features$"))
