...
from .upgrade import (
    ...
    show_payment_instructions, confirm_payment, pre_checkout_handler,
     handle_stars_payment, show_stars_invoice
)
...
from .channel_update import register_channel_update_handler
...
def register_all_handlers(app):
      ...
      # register_notify_handlers(app) 
       ...
       register_channel_update_handler(app)
       ...
       app.add_handler(CallbackQueryHandler(show_stars_invoice,        pattern="^stars_"))
       app.add_handler(CallbackQueryHandler(show_payment_instructions, pattern="^crypto_"))
       ...
       app.add_handler(MessageHandler(
          filters.SUCCESSFUL_PAYMENT, handle_stars_payment
        ))             
