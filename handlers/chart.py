...
from utils.tradingview import generate_chart_image  # your updated async version
...
async def show_chart(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    loading_msg = await update.message.reply_text("⏳ Generating chart... please wait.")

    # ⚠️ Fix: await the async generate_chart_image function and pass context
